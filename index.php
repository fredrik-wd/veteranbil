...
<body class="no-page-top">
            ...
            <div class="navbar-collapse nav-main-collapse collapse">
                ...
                <nav class="nav-main mega-menu one-page-menu">
                    <ul class="nav nav-pills nav-main" id="mainMenu">
                        <li class="active">
                            <a data-hash href="#home"><i class="fa fa-home"></i>Hjem</a>
                        </li>
                        <li>
                            <a data-hash href="#features"><i class="fa fa-fire"></i>Om oss</a>
                        </li>
                        
                        <li>
                            <a data-hash href="#describe"><i class="fa fa-flash"></i>Vår bedrift</a>
                        </li>
                        <li>
                            <a data-hash href="#screenshots"><i class="fa fa-laptop"></i>Galleri</a>
                        </li>
    ...
    <div id="container">
                ...
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="600">
                        ...
                        <div class="tp-caption v-caption-h1 sfl stl"
                            ...
                            data-endelementdelay="0"
                            data-endspeed="300">
                            Blant Norges største<br>
                            utsalgsteder av veteranbiler.
                        </div>
                        ...
                        <div class="tp-caption sfl stl"
                            ...
                            data-endelementdelay="0"
                            data-endspeed="300">
                            <a href='#features' class="btn v-btn v-second-light">Les mer</a>
                        </div>
                        ...
                        <div class="tp-caption sfl stl"
                            ...
                            data-endelementdelay="0"
                            data-endspeed="300">
                            <a href='#ALFA3' class="btn v-btn v-second-light">Våre biler</a>
                        </div>
        ...
        <div class="v-page-wrap no-bottom-spacing">
                ...
                <div class="row center">
                    ...
                    <div class="col-sm-12">
                        ...
                        <p class="lead" style="color: #999;">
                            Vi er en bedrift som selger vetarenbiler.<br>
                            Vi har masse erfaring og er plassert midt i Stokke sentrum!
                        </p>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="feature-box left-icon v-animation pull-top" data-animation="fade-from-left" data-delay="300">
                            ...
                            <div class="feature-box-text">
                                ...
                                <div class="feature-box-text-inner">
                                    Gjennom flere tiår har våre noe utenom det vanlige bilinteresserte ansatte skaffet god erfaring på veteranbiler. 
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="feature-box left-icon v-animation" data-animation="fade-from-left" data-delay="600">
                            ...
                            <div class="feature-box-text">
                                <h3>Beliggenhet</h3>
                                <div class="feature-box-text-inner">
                                    Vi ligger midt i Stokke sentrum, Sentrumsgata 32.
                        ...
                        <div class="feature-box left-icon v-animation" data-animation="fade-from-left" data-delay="900">
                            ...
                            <div class="feature-box-text">
                                <h3>Parkering</h3>
                                <div class="feature-box-text-inner">
                                    Vi har en innendørs lokale med plass til 15 biler i tillegg til en utendørs parkeringsplass med plass til 40 biler.
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="feature-box left-icon v-animation pull-top" data-animation="fade-from-right" data-delay="300">
                            ...
                            <div class="feature-box-text">
                                <h3>Verksted</h3>
                                <div class="feature-box-text-inner">
                                    Vårt verksted med våre mekanikere får til de mest utrolige ting! Vi både fikser og restaurer veteranbiler slik at de blir i topp stand.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="feature-box left-icon v-animation" data-animation="fade-from-right" data-delay="600">
                            ...
                            <div class="feature-box-text">
                                ...
                                <div class="feature-box-text-inner">
                                    Du kan ta kontakt med oss på mail@stokkeveteran.no eller på telefon: +47 91 91 91 91<br />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="feature-box left-icon v-animation" data-animation="fade-from-right" data-delay="900">
                            ...
                            <div class="feature-box-text">
                                <h3>Facebook</h3>
                                <div class="feature-box-text-inner">
                                    Følg vår facebook-side for siste nytt om vår butikk.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row app-brief">
                        ...
                        <div class="col-sm-6">
                            <p class="v-smash-text-large-2x pull-top">
                                <span>Provisjon og videresalg</span>
                            </p>
                            <div class="horizontal-break left"></div>
                            <p class="v-lead">
                                Vi selger biler både mot provisjon og gjennom videresalg. Når du selger din veteranbil gjennom oss kan du være sikker på at de er i de beste hender!
                            </p>

                            <div class="v-spacer col-sm-12 v-height-small"></div>

                            <ul class="v-list-v2">
                                <li class="v-animation" data-animation="fade-from-right" data-delay="150"><i class="fa fa-check"></i><span class="v-lead">Provisjon fra 5%</span></li>
                                <li class="v-animation" data-animation="fade-from-right" data-delay="300"><i class="fa fa-check"></i><span class="v-lead">Verkstedet fikser bilen gratis før salg</span></li>
                                <li class="v-animation" data-animation="fade-from-right" data-delay="450"><i class="fa fa-check"></i><span class="v-lead">Vi har mange besøkende.</span></li>
                                <li class="v-animation" data-animation="fade-from-right" data-delay="600"><i class="fa fa-check"></i><span class="v-lead">Gode annonseringsmuligheter på nett og avis</span></li>
                                <li class="v-animation" data-animation="fade-from-right" data-delay="750"><i class="fa fa-check"></i><span class="v-lead">Vårt salgsteam sørger for at bilen blir solgt</span></li>
            ...
            <div class="v-parallax v-bg-stylish" id="describe">
                <div class="container">
                    <div class="row app-brief">
                        <div class="col-sm-6">
                            <p class="v-smash-text-large-2x pull-top">
                                <span>Vår bedrift</span>
                            </p>
                            <div class="horizontal-break left"></div>
                            <p class="v-lead">
                                Stokke Veteranbil har store parkeringsanlegg for biler og kunder. Vi tilbyr salg mot provisjon og viderasalg av vetarenbiler. Vi har et eget verksted som spesialiserer seg på å fikse og restaurere veteranbiler, slik at både kjøper og selger blir fornøyd. Vi har i tilegg til dette et eget salgsteam som sørger for at bilene blir solgt innen rimelig tid. Vi annonser på nett og i aviser og har en stor kundegruppe som verdsetter denne type biler.
                            </p>

                            <p class="v-lead">
                                Ta kontakt med oss i dag på kontakt@stokkeveteran.no eller tlf +47 91 91 91 91 for en hyggelig prat! Vi ser frem til å møte deg snarest!
                            </p>
                        </div>
            ...
            <div class="container">
                <div class="row center v-counter-wrap">
                    <p class="v-smash-text-large-2x" id="ALFA3">
                                <span>Biler til salgs</span>
                            </p>
                    <br>
                    <?php
                    ...
                    $sql = "SELECT nr, reg, modell, merke, farge, ar, solgt, eu FROM bil";
                    $result = $conn->query($sql);
                    
                    if ($result->num_rows > 0) {
                        echo "<table id='table1'><tr><th>ID</th><th>Registreringsnummer</th><th>Modell</th><th>Merke</th><th>Farge</th><th>År</th><th>Solgt</th><th>Eu godkjent</th></tr>";
                        // output data of each row
                        while($row = $result->fetch_assoc()) {
                            echo "<tr><td>".$row["nr"]."</td><td>".$row["reg"]."</td><td> ".$row["modell"]."</td><td>".$row["merke"]."</td><td>".$row["farge"].  "</td><td>".$row["ar"]."</td><td>".$row["solgt"]."</td><td>". $row["eu"]."</td></tr>";
                        }
                        echo "</table>";
                    } else {
                        echo "0 results";
                    ...
                    <h1>LEGG TIL BIL I DATABASE:</h1>
                    
                    <form action="process.php" method="post">
                    
                        <label for="reg">Registreringsnummer:</label>
                        <input maxlength="10" size="40" type="text" name="reg" id="reg">
                        ...
                        <label size="40px" for="merke">Merke:</label>
                    ...
                    <br>
                        ...
                        <label for="solgt">Solgt:</label>
                        <input type="text" name="solgt" id="solgt">
                    
                    <br>
                    
                        <label for="eu">EU Godkjent:</label>
                        <input type="text" name="eu" id="eu">
                    
                    <input type="submit" value="Legg til">
                </form>
                    
                <h3>NB: denne formen burde egentlig ligge bak en passordbeskyttet side, men for å ikke lage prøven unødvendig komplisert plasserte jeg den her.</h3>
                ...
                <div class="container">
                    <div class="row center">
                        <div class="col-sm-12">
                            ...
                            <div class="horizontal-break"></div>
                            <p class="lead" style="color: #999;">
                                Her er noen biler vi har solgt nylig.
                            </p>
                        </div>
                        <div class="v-spacer col-sm-12 v-height-standard"></div>
                    </div>
                    ...
                    <div class="row center">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="v-content-wrapper">
                                ...
                                <p class="v-smash-text-large-2x">
                                    <span>Motta vårt nyhetsbrev!</span>
                                </p>
                                ...
                                <form class="subscription-form form-inline">
                                    ...
                                    <input type="email" name="EMAIL" placeholder="din e-post" class="subscriber-email form-control input-box">
                                    <a href="#" type="submit" class="subscriber-button btn v-btn v-medium-button no-three-d v-belize-hole"><i class="fa fa-fire"></i>Abonner</a>
                                </form>
                            </div>
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <label>Ditt navn <span class="required">*</span></label>
                                            <input type="text" value="" maxlength="100" class="form-control" name="name" id="name">
                                        </div>
                                        <div class="col-sm-4">
                                            <label>Din e-post <span class="required">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <br />
                                        <button name="submit" type="submit" id="sendmesage" class="btn v-btn no-three-d">Send melding</button>
                                    </div>
                                </div>
                            </form> 
        ...
        <div class="footer-wrap">
                        ...
                        <div class="col-sm-5">
                            <section class="widget">
                                ...
                                <p class="pull-bottom-small">
                                    Stokke Veteranbiler videreselger og assister salg mot provisjon.
                                </p>
                                <p>
                        ...
                        <div class="col-sm-3">
                            <section class="widget">
                                ...
                                <div class="footer-contact-info">
                                    <ul>
                                        <li>
                                            <p><i class="fa fa-building"></i>Stokke Veteranbiler </p>
                                        </li>
                                        <li>
                                            <p><i class="fa fa-map-marker"></i>Suntrumsgata 32, 3731 Stokke </p>
                                        </li>
                                        <li>
                                            <p><i class="fa fa-envelope"></i><strong>E-post:</strong> <a href="mailto:mail@example.com">mail@stokkeveteran.no</a></p>
                                        </li>
                                        <li>
                                            <p><i class="fa fa-phone"></i><strong>Telefon:</strong> +47 91 91 91 91</p>
                                        </li>
                                    </ul>
                                    <br />
            ...
            <div class="copyright">
                <div class="container">
                    <p>© Copyright 2016 by Stokke Veteranbiler A/S.</p>
                    <nav class="footer-menu std-menu">
                        <ul class="menu">
                            <li><a href="#">Hjem</a></li>
                            <li><a href="#services">Om oss</a></li>
